    <div id="conteneur">
        ...
        <div id="menu_admin" class="menu">{include file="menu.tpl" menu_liste=$menu_liste_admin}</div>
        <div id="leaderboard">{include file='leaderboard.tpl'}</div>
        <div id="menu_langue" class="menu">{include file="menu.tpl" menu_liste=$menu_liste_langues}</div>
        <div class="clear"></div>

...
--
-- Serveur: localhost
-- Généré le : Lun 24 Janvier 2011 à 16:37
...
INSERT INTO `contenus` (`id_contenu`, `titre`, `sous_titre`, `contenu`, `position`, `actif`, `websites_id_website`, `categories_id_categorie`, `types_contenus_id_types_contenus`, `utilisateurs_id_utilisateur`, `langues_id_langue`) VALUES
(8, 'Accueil', 'Je ne suis pas un héro...', 'test -> Accueil\r\npour les petits poulets', 1, '1', 2, 1, 1, 2, 1);
...
INSERT INTO `fields` (`id_field`, `balise_field`, `type_field`, `html_id_field`, `nom_field`, `class_field`, `valeur_defaut`, `position`, `actif`, `labels_id_label`) VALUES
(1, 'input', 'text', 'titre_pages', 'titre_page', '', 'Ceci est un titre de page', 1, '1', 3);
...
CREATE TABLE IF NOT EXISTS `utilisateurs` (
  ...
  `pwd_utilisateur` int(11) NOT NULL,
  `langues_id_langue` int(11) NOT NULL,
...
INSERT INTO `websites` (`id_website`, `nom`) VALUES
(2, 'Yungi Design');

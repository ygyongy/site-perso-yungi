...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `site_perso_yungi`.`view_anonymous_contenus` (`id_contenu` INT, `titre_html` INT, `titre` INT, `sous_titre` INT, `contenu` INT, `position_contenu` INT, `actif_contenu` INT, `droit_contenu` INT, `websites_id_website` INT, `sous_categories_id_sous_categorie` INT, `categories_id_categorie` INT, `cat_type_contenu` INT, `cat_max_par_page` INT, `cont_type_contenu` INT, `langues_id_langue` INT);

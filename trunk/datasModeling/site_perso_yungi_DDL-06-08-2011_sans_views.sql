...
UPDATE  `site_perso_yungi`.`contenus` SET  `droit_contenu` =  'U' WHERE  `contenus`.`id_contenu` =5 AND  `contenus`.`langues_id_langue` =1 LIMIT 1 ;

UPDATE  `site_perso_yungi`.`contenus` SET  `droit_contenu` =  'U' WHERE  `contenus`.`id_contenu` =6 AND  `contenus`.`langues_id_langue` =1 LIMIT 1 ;

UPDATE  `site_perso_yungi`.`contenus` SET  `droit_contenu` =  'U' WHERE  `contenus`.`id_contenu` =7 AND  `contenus`.`langues_id_langue` =1 LIMIT 1 ;
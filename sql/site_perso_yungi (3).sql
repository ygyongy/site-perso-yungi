...
--
-- Serveur: localhost
-- Généré le : Sam 07 Mai 2011 à 16:19
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='le champ contenu JSON avec le contenu récupérer' AUTO_INCREMENT=12 ;
...
(9, 'Accueil', 'Accueil', '{"titre":"Accueil","contenu":"page d''accueil"}', 1, '1', '0', 2, 1, 1, 1, 1),
(9, 'Hause', 'Hause', '{"titre":"Hause", "contenu":"Wilkommen zu unsere neue webiste"}', 1, '1', '0', 2, 1, 1, 1, 2),
(9, 'home', 'home', '{"titre":"Home", "contenu":"Welcome on our website"}', 1, '1', '0', 2, 1, 2, 1, 3),
(11, 'home 2', 'home 2', '{"titre":"Home 2", "contenu":"Funk 4 ever!!!"}', 2, '1', '0', 2, 1, 1, 1, 3);

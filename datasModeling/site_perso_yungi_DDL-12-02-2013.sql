...
CREATE  TABLE IF NOT EXISTS `site_perso_yungi`.`contenus` (
  ...
  INDEX `fk_contenus_types_contenus` (`types_contenus_id_type_contenu` ASC) ,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `site_perso_yungi`.`view_anonymous_menu` (`id_categorie` INT, `titre_html_categorie` INT, `nom_categorie` INT, `emplacement_categorie` INT, `actif_categorie` INT, `position_categorie` INT, `droit_categorie` INT, `langues_id_langue` INT, `types_contenus_id_type_contenu` INT, `categorie_max_par_page` INT, `id_type_contenu` INT, `nom_type_contenu` INT, `actif_type_contenu` INT);

-- -----------------------------------------------------
-- Placeholder table for view `site_perso_yungi`.`view_anonymous_contenus`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `site_perso_yungi`.`view_anonymous_contenus` (`id_contenu` INT, `titre_html` INT, `titre_url` INT, `titre` INT, `sous_titre` INT, `contenu` INT, `position_contenu` INT, `actif_contenu` INT, `droit_contenu` INT, `websites_id_website` INT, `sous_categories_id_sous_categorie` INT, `categories_id_categorie` INT, `cat_type_contenu` INT, `cat_max_par_page` INT, `cont_type_contenu` INT, `langues_id_langue` INT);
...
SELECT *
FROM categories c, types_contenus t
WHERE droit_categorie IS NULL 
        AND actif_categorie <> '0'
		AND c.types_contenus_id_type_contenu = t.id_type_contenu
ORDER BY c.position_categorie;
...
SELECT cont.id_contenu, cont.titre_html, cont.titre_url, cont.titre, cont.sous_titre, cont.contenu, cont.position_contenu, cont.actif_contenu, cont.droit_contenu, cont.websites_id_website, cont.sous_categories_id_sous_categorie, cont.categories_id_categorie, cat.types_contenus_id_type_contenu as cat_type_contenu, cat.categorie_max_par_page as cat_max_par_page, cont.types_contenus_id_types_contenus as cont_type_contenu, cont.langues_id_langue
